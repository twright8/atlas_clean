 ...
 */
export function updateDashboard(data, dateRange) {
...
function updateTimeSeriesChart(data, dateRange) {
    ...
    // Add data points
    timeSeriesChart.selectAll('.data-point')
        .data(timeData)
        .enter()
        .append('circle')
...
function updateCategoryChart(data) {
    ...
    // Update axes
    categoryChart.select('.x-axis')
        .call(d3.axisBottom(x).ticks(5));
    
    categoryChart.select('.y-axis')
        .call(d3.axisLeft(y))
        .selectAll('text')
        .style('text-anchor', 'end');
    ...
    // Create bars
    categoryChart.selectAll('.category-bar')
        .data(topCategories)
        .enter()
        .append('rect')
    ...
    // Add count labels
    categoryChart.selectAll('.count-label')
        .data(topCategories)
        .enter()
        .append('text')
...
function updateTopCountriesChart(data) {
    ...
    // Update axes
    topCountriesChart.select('.x-axis')
        .call(d3.axisBottom(x).ticks(5));
    
    topCountriesChart.select('.y-axis')
        .call(d3.axisLeft(y))
        .selectAll('text')
        .style('text-anchor', 'end');
    ...
    // Create bars
    topCountriesChart.selectAll('.country-bar')
        .data(topCountries)
        .enter()
        .append('rect')
    ...
    // Add count labels
    topCountriesChart.selectAll('.count-label')
        .data(topCountries)
        .enter()
        .append('text')
        .attr('class', 'count-label')
